...
* sourceUri = "http://hl7.eu/fhir/ig/xpandh/lab/StructureDefinition/LabReport"					
* targetUri = "http://hl7.eu/fhir/ig/xpandh/lab/StructureDefinition/Bundle-lab-xpandh"					
					
* group[+].source = "http://hl7.eu/fhir/ig/xpandh/lab/StructureDefinition/LabReport"					
* group[=].target = "http://hl7.eu/fhir/ig/xpandh/lab/StructureDefinition/DiagnosticReport-eu-lab"					
...
* group[+].source = "http://hl7.eu/fhir/ig/xpandh/lab/StructureDefinition/LabReport"					
* group[=].target = "http://hl7.eu/fhir/ig/xpandh/lab/StructureDefinition/Composition-eu-lab"					
...
* group[=].element[+].code = #LabReport.header.payer					
* group[=].element[=].display = "A.1.3 Health insurance and payment information"					
* group[=].element[=].target.code = #Composition.extension(http://hl7.eu/fhir/ig/xpandh/lab/StructureDefinition/composition-basedOn-order-or-requisition).resolve().ofType(ServiceRequest).insurance.resolve().ofType(Coverage)					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #relatedto					
...
* group[=].element[+].code = #LabReport.order					
* group[=].element[=].display = "A.2-A.3 Order"					
* group[=].element[=].target.code = #Composition.extension(http://hl7.eu/fhir/ig/xpandh/lab/StructureDefinition/composition-basedOn-order-or-requisition).resolve().ofType(ServiceRequest)					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #relatedto					
